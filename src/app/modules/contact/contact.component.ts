...
export class ContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoS.setTitle('Contacteer Vsoft');
    this.seoS.replaceTags([
      {
        name: 'keywords',
        content: 'Vsoft, contact pagina, contact page',
      },
      {
        name: 'description',
        content: 'Vsoft pagina, contactformulier',
      },
  ...
  onOfficeModal() {
    ...
    this.bsModalRef = this.modalService.show(OfficeInfoModalComponent, {
      initialState,
    });
